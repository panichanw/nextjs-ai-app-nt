...
- ถ้ายังไม่มีฐานข้อมูล ให้อ่านไฟล์นี้เพื่อสร้างฐานข้อมูล `assets/install_mariadb_with_docker.txt`

- ถ้ายังไม่มีตาราง ให้อ่านไฟล์นี้เพื่อสร้างตาราง `assets/create_table_ecommerce.sql`
